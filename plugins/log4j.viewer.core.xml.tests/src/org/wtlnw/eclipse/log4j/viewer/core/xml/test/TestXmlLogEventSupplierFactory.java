...
public class TestXmlLogEventSupplierFactory {
	...
	void testComplete() throws IOException, InterruptedException {
		runWithConfiguration(config(CONFIG_COMPLETE), new XmlLogEventSupplierFactory());
	}

	@Test
	void testFragments() throws IOException, InterruptedException {
		runWithConfiguration(config(CONFIG_FRAGMENTS), new XmlLogEventSupplierFactory());
	}

	@Test
	void testMultiSuppliers1() throws IOException, InterruptedException {
		runWithConfiguration(config(CONFIG_FRAGMENTS), new SerializedLogEventSupplierFactory(), new XmlLogEventSupplierFactory());
	}

	@Test
	void testMultiSuppliers2() throws IOException, InterruptedException {
		runWithConfiguration(config(CONFIG_SERIALIZED), new XmlLogEventSupplierFactory(), new SerializedLogEventSupplierFactory());
	}
